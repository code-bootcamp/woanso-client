            ...
            {isOpenQ2 && (
              <S.Answer>
                <p>
                  ...
                  ⛔️ 금액 차감 후 지불되는 경우
                  <br />
                  - 책에 오물 및 훼손이 발견된 경우 일정 금액 차감 후 환불
                  진행됩니다.
                  <br />- 대여 기간을 초과한 경우 기간에 대한 금액 차감 후 한불
                  진행됩니다.
                </p>
              </S.Answer>
            )}
            ...
            {isOpenQ3 && (
              <S.Answer>
                <p>
                  ...
                  기사님께서 수거해가십니다.
                  <br />
                  주소지에 따라 기사님의 수령시간이 다를 수 있으니 가급적 오전
                  중에 두시는 걸 권합니다.
                </p>
              </S.Answer>
            )}
            ...
            {isOpenQ4 && (
              <S.Answer>
                <p>
                  ...
                  <br />
                  포인트로 일정 금액 이상 결제한 회원에게는 할인 쿠폰을
                  제공해드립니다.
                  <br />
                  포인트로 결제시 더 많은 할인 혜택이 제공되니 많은
                  이용바랍니다.
                </p>
              </S.Answer>
            )}
